...
public class RoundedTextView extends AppCompatTextView {
    ...
    public RoundedTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mBorderWidth = a.getDimensionPixelSize(R.styleable.RoundedTextView_rtv_border_width, mBorderWidth);
    ...
    //背景色，边框色，文字颜色
    public void setColors(int bgColor, int borderColor, int textColor) {
        setRoundedBackgroundColor(bgColor);
        setRoundedBorderColor(borderColor);
    ...
    public boolean checkUsed() {
        return mCornerRadius > 0 || mBorderWidth != 0 || mBackgroundColor != null;
    }
    ...
    static class MyGradientDrawable extends GradientDrawable {

...
public class SuperLinearLayout extends LinearLayout
    ...
    public SuperLinearLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.SuperLinearLayout);
        mAutoCheck = array.getBoolean(R.styleable.SuperLinearLayout_sll_auto_check, mAutoCheck);
        mChecked = array.getBoolean(R.styleable.SuperLinearLayout_sll_checked, mChecked);

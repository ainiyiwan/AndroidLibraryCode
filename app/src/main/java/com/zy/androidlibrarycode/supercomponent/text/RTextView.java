...
public class RTextView extends AppCompatTextView {
     ...
     * @param pressedColor
     */
    public void setBackground(int normalColor, int pressedColor) {
        mBackgroundColorNormal = normalColor;
        mBackgroundColorPressed = pressedColor;
        mBackgroundNormal.setColor(mBackgroundColorNormal);
        mBackgroundPressed.setColor(mBackgroundColorPressed);
        setup();
    }
    ...
    public void setEnableBorder(boolean enable) {
        if (!enable) {
            mBackgroundNormal.setColor(Color.TRANSPARENT);
            mBackgroundPressed.setColor(Color.TRANSPARENT);
            mBackgroundUnable.setColor(Color.TRANSPARENT);
        }
        setBorder();
    }
